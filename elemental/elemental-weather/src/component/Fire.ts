...
import * as PARTICLES from '/@/utils/ParticleSystem';
...
export default class Fire {
    ...
    createFireMaterial() {
        const fireTexture = this.weather.resources.items.fireTexture;
        if (fireTexture) {
    ...
    createSmokeMaterial() {
        const smokeTexture = this.weather.resources.items.smokeTexture;
        if (smokeTexture) {
    ...
    createAmberMaterial() {
        const amberTexture = this.weather.resources.items.particleTexture;
        if (amberTexture) {
