...
export default class Bridge extends Object3DComponent {
    ...
    protected async onInitialize(_config?: ComponentConfig): Promise<void> {
        ...
        const bridgeResource = this.resourcesManager.getItem("bridgeModel");
    ...
    private async configureMaterials(): Promise<void> {
        ...
        // 加载纹理资源
        const woodColorMap = this.resourcesManager.getItem("woodColorTexture");
        const woodNormalMap = this.resourcesManager.getItem("woodNormalTexture");
