...
export default class Tent extends Object3DComponent {
    ...
    protected async onInitialize(_config?: ComponentConfig): Promise<void> {
        ...
        const tentResource = this.resourcesManager.getItem("tentModel");
    ...
    public onTimeChanged(data: TimeChangedData): void {
        ...
        const timeKey = (hour >= 6 && hour < 18) ? 'day' : 'night';
    ...
    private async configureMaterials(): Promise<void> {
        ...
        // 加载纹理资源
        const woodColorTexture = this.resourcesManager.getItem("woodColorTexture");
        const woodNormalTexture = this.resourcesManager.getItem("woodNormalTexture");
        const woodAOTexture = this.resourcesManager.getItem("woodAOTexture");
    ...
    private getLampColor(): Three.Color {
        ...
        return new Three.Color(1.0, 0.8, 0.4);
    }
